...
> *As Views são uns dos recursos mais legais do SQL Server, com ela podemos deixar códigos escritos salvos diretamento no banco de dados para utilizar em várias situações, e uma das que mais ocorre é utilizar na integração com Excel e Power BI, abaixo segue a criação de uma View para o ERP Protheus da TOTVS S.A*

* **Contexto**

 *Desenvolver uma view que mostre de forma clara todos os pedidos de venda com o status de bloqueado e liberado , lembrando que os tipos que devem retornar na view são apenas os tipos de produto PC,PN e OL*
